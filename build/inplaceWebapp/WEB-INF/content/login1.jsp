        ...
        <div class="" id="login-wrapper">
            ...
            <div class="row">
                    ...
                    <div class="account-box"> 
                        <form role="form" action="index.html">
                            <div class="form-group">
                                ...
                                <input type="text" id="ssn" class="form-control" placeholder="请输用户名" required autofocus/>
                            </div>
                            <div class="form-group">
                ...
                <span>请选择身份</span>
                            ...
                            <button class="btn btn btn-primary pull-right" type="button" onclick="login()"> 登 录</button>
                        </form>

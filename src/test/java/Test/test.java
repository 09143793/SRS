...
public class test {
	...
	public void add(){
		...
		String courseNo = "ABC123";
		String courseName = "English A";
		String credits = "2.5";
		String prerequisite = "ART101";
	...
	public void findPlan(){
		Student student = new Student("Lily", "111-11-1111", "Math", "M.S.");
